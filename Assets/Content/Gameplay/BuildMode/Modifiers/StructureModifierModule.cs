...
[System.Serializable]
public class StructureModifierModule
{
    internal List<StructureStat> stats { get; private set; } = new();
    ...
    /// </summary>
    internal void AddModifier(StructureAreaModifier mod)
    {
        foreach (StructureStat stat in stats)
        {
    ...
    /// </summary>
    internal void RemoveModifier(StructureAreaModifier mod)
    {
        foreach (StructureStat stat in stats)
        {
            if (stat.statType == mod.modType)
